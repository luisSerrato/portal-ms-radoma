...
/**
 * This is a APIFactoryNotFoundException class to handle Resource not found exceptions.
 *
 * @author AM241297
 *
 */
public class ApiFactoryNotFoundException extends ApiFactoryBaseException {
   ...
   */
  public ApiFactoryNotFoundException(String type, String code, String details, String location,
      String moreInfo) {
