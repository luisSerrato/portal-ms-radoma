 ...
 *
 */
public class ApiFactoryUnauthorizedException extends ApiFactoryBaseException {
   ...
   * Default constructor.
   */
  public ApiFactoryUnauthorizedException() {
    super();
  }
   ...
   */
  public ApiFactoryUnauthorizedException(String type, String code, String details, String location,
      String moreInfo) {
