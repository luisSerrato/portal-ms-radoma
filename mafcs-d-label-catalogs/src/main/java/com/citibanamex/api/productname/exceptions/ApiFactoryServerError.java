...
/**
 * This is a Base Exception to handle any unexpected exceptions like server errors.
 *
 * @author AM241297
 *
 */
public class ApiFactoryServerError extends ApiFactoryBaseException {
   ...
   */
  public ApiFactoryServerError(String type, String code, String details, String location,
      String moreInfo) {
