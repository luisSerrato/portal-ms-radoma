...
public class LineOfBusinessControllerTest {
	...
	public void testTypeOfPersonResponseAll() throws Exception{
		...
		Mockito.when(lineOfBusinessService.getLineofBusiness(Mockito.any())).thenReturn(lineOfBusinessResponse);		
		this.mockMvc.perform(MockMvcRequestBuilders.get("/api/private/v1/consumer-services/catalogs/customers/occupation/sector")
				.param("professionFilter", professionFilter)
