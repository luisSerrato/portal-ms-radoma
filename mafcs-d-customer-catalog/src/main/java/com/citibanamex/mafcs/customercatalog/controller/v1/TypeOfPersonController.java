...
public class TypeOfPersonController {
   ...
   * /private/v1/consumer-services/catalogs/customers/resident/status.
   */
  @ApiOperation(value = "Retrieve the Person Type",
      notes = "This API is used to get the type of person", produces = "application/json")
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "Ok", response = PersonTypeResponse.class,
          responseContainer = "Object"),
      @ApiResponse(code = 400, message = "Bad request"),
      @ApiResponse(code = 500, message = "Internal server error")})
  @RequestMapping(value = "/consumer-services/catalogs/customers/resident/status",
